...
module SwaggerClient
  class InlineResponse2005
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'swinlaneId')
        self.swinlane_id = attributes[:'swinlaneId']
      end
    end
    ...
    def hash
      [_id, title, description, list_id, swinlane_id].hash
    end

...
module SwaggerClient
  class ListsWiplimit
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'soft')
        self.soft = attributes[:'soft']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @soft.nil?
        invalid_properties.push('invalid value for "soft", soft cannot be nil.')
      end

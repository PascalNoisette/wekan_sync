...
module SwaggerClient
  class InlineResponse2001
    ...
    attr_accessor :default_swimlane_id

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'_id' => :'_id',
        :'default_swimlane_id' => :'defaultSwimlaneId'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'defaultSwimlaneId')
        self.default_swimlane_id = attributes[:'defaultSwimlaneId']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _id == o._id &&
          default_swimlane_id == o.default_swimlane_id
    end

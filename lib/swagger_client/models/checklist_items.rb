...
module SwaggerClient
  ...
  class ChecklistItems
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isFinished')
        self.is_finished = attributes[:'isFinished']
      end

      if attributes.has_key?(:'checklistId')
        self.checklist_id = attributes[:'checklistId']
      end
    ...
    def list_invalid_properties
      ...
      if @is_finished.nil?
        invalid_properties.push('invalid value for "is_finished", is_finished cannot be nil.')
      end

      if @checklist_id.nil?
        invalid_properties.push('invalid value for "checklist_id", checklist_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_finished.nil?
      return false if @checklist_id.nil?
    ...
    def hash
      [title, sort, is_finished, checklist_id, card_id, created_at, modified_at].hash
    end
